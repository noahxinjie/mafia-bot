...
class Sheriff(Town):
    ...
    @staticmethod
    def info() -> str :
        return "Sheriff is part of the Town. There are at most 3 sheriffs in a game. The sheriff can use their ability "\
            "during the night to interrogate someone to find out if they are innocent or guilty. If the target is "\
                "innocent, they are either the Godfather or a Town member. If the target is guilty, they are part of the Mafia."
